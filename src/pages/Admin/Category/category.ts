                ...
                <table class="table-auto border mt-5 mx-auto w-[80%]">     
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td class="border">
                                <a href="/admin/categories/${item.id}/edit"><svg xmlns="http://www.w3.org/2000/svg" class="h-6 w-6 mx-auto" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
